...
@WebServlet(name = "StarredUserController", urlPatterns = {"/StarredUserController"})
public class StarredUserController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(StarredUserController.class);

    private static final String ERROR = AppUtils.pagePrefix +"userStar.jsp";
    private static final String SUCCESS = AppUtils.pagePrefix +"userStar.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (googleFolderIdParent == null) {
                List<String> rootFolderIds = dao.getRootFoldersStarredByUserID(loggedUser.getUserID());
                List<String> fileIds = dao.getRootFilesByUserID(loggedUser.getUserID());
