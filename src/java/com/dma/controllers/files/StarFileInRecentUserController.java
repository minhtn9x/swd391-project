...
@WebServlet(name = "StarFileInRecentUserController", urlPatterns = {"/StarFileInRecentUserController"})
public class StarFileInRecentUserController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(StarFileInRecentUserController.class);
