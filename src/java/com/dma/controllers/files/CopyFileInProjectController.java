...
@WebServlet(name = "CopyFileInProjectController", urlPatterns = {"/CopyFileInProjectController"})
public class CopyFileInProjectController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(CopyFileInProjectController.class);
