...
@WebServlet(name = "RenameFileInProjectController", urlPatterns = {"/RenameFileInProjectController"})
public class RenameFileInProjectController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(RenameFileInProjectController.class);
