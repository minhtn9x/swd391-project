...
@WebServlet(name = "CopyFileInStarredUserController", urlPatterns = {"/CopyFileInStarredUserController"})
public class CopyFileInStarredUserController extends HttpServlet {

    static final Logger LOGGER = Logger.getLogger(CopyFileInStarredUserController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.addFileToStarredUser(loggedUser.getUserID(), currentFolderId == null ? "null" : currentFolderId, file.getId(), file.getName());
