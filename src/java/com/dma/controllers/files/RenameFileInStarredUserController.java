...
@WebServlet(name = "RenameFileInStarredUserController", urlPatterns = {"/RenameFileInStarredUserController"})
public class RenameFileInStarredUserController extends HttpServlet {

    static final Logger LOGGER = Logger.getLogger(RenameFileInStarredController.class);
