...
@WebServlet(name = "RemoveFileInStarredUserController", urlPatterns = {"/RemoveFileInStarredUserController"})
public class RemoveFileInStarredUserController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(RemoveFileInStarredUserController.class);
