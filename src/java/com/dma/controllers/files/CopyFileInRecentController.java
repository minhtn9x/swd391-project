...
@WebServlet(name = "CopyFileInRecentController", urlPatterns = {"/CopyFileInRecentController"})
public class CopyFileInRecentController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(CopyFileInRecentController.class);
