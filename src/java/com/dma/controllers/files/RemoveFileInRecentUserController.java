...
@WebServlet(name = "RemoveFileInRecentUserController", urlPatterns = {"/RemoveFileInRecentUserController"})
public class RemoveFileInRecentUserController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(RemoveFileInRecentUserController.class);
