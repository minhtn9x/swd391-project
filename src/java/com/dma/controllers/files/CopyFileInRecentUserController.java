...
@WebServlet(name = "CopyFileInRecentUserController", urlPatterns = {"/CopyFileInRecentUserController"})
public class CopyFileInRecentUserController extends HttpServlet {

    static final Logger LOGGER = Logger.getLogger(CopyFileInRecentUserController.class);
