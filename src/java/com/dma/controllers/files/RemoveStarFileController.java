...
@WebServlet(name = "RemoveStarFileController", urlPatterns = {"/RemoveStarFileController"})
public class RemoveStarFileController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(RemoveStarFileController.class);
