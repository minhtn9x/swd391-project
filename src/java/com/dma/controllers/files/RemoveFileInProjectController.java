...
@WebServlet(name = "RemoveFileInProjectController", urlPatterns = {"/RemoveFileInProjectController"})
public class RemoveFileInProjectController extends HttpServlet {
    static final Logger LOGGER = Logger.getLogger(RemoveFileInProjectController.class);
