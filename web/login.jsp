        ...
        <div class="d-md-flex half">
            <div class="bg" 
                 style="background-image: url('images/bg_1.png'); 
                        background-size: 210%; width: 55%; 
                        background-position-x: 20%;
                        background-repeat: no-repeat;
                        background-color: #6ab0fa"></div>
            <div class="contents">
                <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="form-block mx-auto">
                                <div class="text-center mb-5">
                                    <h3 class="text-uppercase" style="color: #3f77df; font-weight: 900">Login</h3>
                                </div>
                                <form action="MainController" method="post">
                                    ...
                                    <input type="submit" name="action" value="Sign in" class="btn btn-block py-2 btn-primary" style="background-color: #3f77df; border: none">
                                    ...
                                    <div class="row" style="padding: 20px;">
                                        ...
                                        <div class="col-lg-5">
                                            <a href="MainController?action=CreateAccount">
                                                Create an account
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <a href="https://accounts.google.com/o/oauth2/auth?scope=profile email
                                           &redirect_uri=http://localhost/SE1622_GROUP6_DMA/LoginGoogleController
                                           &response_type=code
                                           &client_id=513871923778-9d442cqfr7cln9v17bf059jsmfphqfbk.apps.googleusercontent.com
