        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div class="nav-item active">
                    <a class="nav-link" href="MainController?action=Recent">
                ...
                <div class="nav-item">
                    <a class="nav-link" href="MainController?action=Starred">
                ...
                <div class="nav-item">
                    <a class="nav-link" href="MainController?action=Bin">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="dropdown" style="float: right">
                                                                    ...
                                                                    <div class="dropdown-content">
                                                                        ...
                                                                        <hr style="margin: 0">
                                                                        <a href="MainController?action=StarFileInRecentUser&fileId=${file.id}">
                                                                        ...
                                                                        <hr style="margin: 0">
                                                                        <a href="MainController?action=CopyFileInRecentUser&fileId=${file.id}&fileName=${file.name}">
                                                                        ...
                                                                        <hr style="margin: 0">
                                                                        <a href="MainController?action=RemoveFileInRecentUser&fileId=${file.id}">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="dropdown" style="float: right">
                                                                                ...
                                                                                <div class="dropdown-content">
                                                                                    ...
                                                                                    <a href="MainController?action=ReportFile&fileId=${file.id}&fileName=${file.name}">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="MainController">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                        <button type="submit" class="btn btn-primary" name="action" value="RenameFileInRecentUser">OK</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
