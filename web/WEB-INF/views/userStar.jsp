            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                                                ...
                                                <c:if test="${counter.count %5 == 1}">
                                                    <div class="row">
                                                        <div class="col-lg-2" style="border-style: solid;padding: 20px; margin: 20px;">
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <a href="MainController?action=UserHome&folderId=${folder.id}">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-content">
                                                                            <a href="MainController?action=RemoveStarFolderUser&folderId=${folder.id}">
                    ...
                    document.getElementById('renameId').value = '${folder.id}'" 
                                                                            ...
                                                                            <hr style="margin: 0">
                                                                            <a href="MainController?action=RemoveFolderInStarredUser&folderId=${folder.id}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown" style="float: right">
                                                            ...
                                                            <div class="dropdown-content">
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=RemoveStarFileUser&fileId=${file.id}">
                                                                    <i class="fas fa-regular fa-star"></i>&ensp;
                                                                    Remove from Starred
                                                                </a>
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=CopyFileInStarredUser&fileId=${file.id}&fileName=${file.name}">
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=RemoveFileInStarredUser&fileId=${file.id}">
                                                                    <i class="fas fa-solid fa-trash"></i>&ensp;
                                                                    Remove
                                                                </a>
                                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="RenameFolderInStarredUser">OK</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary" name="action" value="RenameFileInStarredUser">OK</button>
                                </div>
                            </form>
                        </div>
                    </div>
