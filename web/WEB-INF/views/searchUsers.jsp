<%-- 
    ...
    Created on : Jun 21, 2022, 8:40:18 AM
    Author     : giahu
--%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <h1>
                                <a style="text-decoration: none" href="MainController?action=viewProject"><i class="fas fa-arrow-left"></i>&emsp;</a>
                                Project name: ${sessionScope.pr.projectName}
                            </h1>
                        </div>
                        <a class="btn btn-primary px-4 float-right" href="MainController?action=projectDetail&pid=${sessionScope.pr.projectID}">Project Detail</a>


                        <h1 class="h3 mb-4 text-gray-800" style="margin-top: 20px">Add user to project</h1>
                        <!-- Table -->
                        <div>

                            <div class="container p-3 my-3 border" style="width: 50%;">
                                <!-- Table -->     
                                <form action ="MainController" method="post">
                                    Search user to add
                                    <input type="text" name="txtsearch" value="${param.txtsearch}" style="margin-left: 20px;">
                                    <input type="hidden" name="projectID" value="${sessionScope.pr.projectID}" />
                                    <input type="hidden" name="projectName" value="${sessionScope.pr.projectName}" />
                                    <input type="hidden" name="projectDesc" value="${sessionScope.pr.projectDesc}" />
                                    <input class="btn btn-primary px-4" style="margin-left: 20px;" type="submit" value="searchUser" name="action">
                                </form>
                                <c:if test="${sessionScope.USER!=null&&!sessionScope.USER.isEmpty()}">
                                    <table border="1" class="table">
                                        ...
                                        <tbody>
                                            <c:forEach var="x" items="${sessionScope.USER}">
                                                <tr>
                                                    <td>
                                                        ${x.userID}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary">
                                                            <a href="MainController?action=addToProject&pid=${sessionScope.pr.projectID}&uid=${x.userID}"
                                                               style="color: white;">Add to project</a>
                                        ...
                                        <c:if test="${sessionScope.USER.isEmpty()}">
                                        <p>There are no user like that</p>
                                    </c:if>
