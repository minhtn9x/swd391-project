                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-content">
                                                                            <a href="MainController?action=RestoreFolder&projectId=${param.projectId}&folderId=${folder.id}">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="dropdown" style="float: right">
                                                            ...
                                                            <div class="dropdown-content">
                                                                <a href="MainController?action=RestoreFile&projectId=${param.projectId}&fileId=${file.id}">
                                                                    <i class="fas fa-solid fa-rotate-left"></i>&ensp;
                                                                    Restore
                                                                </a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary" name="action" value="Delete Folder">Delete forever</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary" name="action" value="Delete File">Delete forever</button>
                                </div>
                            </form>
                        </div>
                    </div>
