<%-- 
    ...
    Created on : Jun 2, 2022, 9:46:03 PM
    Author     : giahu
--%>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div>
                            ...
                            <form action="MainController" method="POST" class="projectform">
                                <h1>Create new project </h1>
                                <div class="container p-3 my-3 border" style="height: 50%; width: 40%;">
                                    <table class="table">
                                        <tr><td>Project Name</td><td><input type="text" name="projectname" required="" value="${param.projectname}"></td></tr>
                                        <tr><td>Description</td><td><input type="text" name="projectdesc" required="" value="${param.projectdesc}"></td></tr>
                                        <tr><td>Start Date</td><td><input id="startDate" class="form-control"  type="date" name="startdate" required="" min="" value="${param.startdate}"></td></tr>
                                        <tr>
                                            <td>End Date</td>
                                            <td><input id="endDate" class="form-control"  type="date" name="enddate" min="" required="" value="${param.enddate}"></td>
                                            <td class="text-danger ml-1">${requestScope.ERROR}</td>
                                        </tr>
                                        <tr><td colspan><input class="btn btn-primary px-4" type="submit" value="Create Project" name="action"></td></tr>
                                    </table>
                                </div>
