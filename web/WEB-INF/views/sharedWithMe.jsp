        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div class="nav-item active">
                    <a class="nav-link active" href="MainController?action=SharedWithMe">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <a href="MainController?action=viewProject" class="btn btn-primary">Project List</a>
                            </div>
                        </div>
                        ...
                        <c:if test="${empty breadcrumbs}">
                            <ol class="breadcrumb h5 mb-4 text-gray-800">
                                <li class="breadcrumb-item">Shared with me</li>
                            </ol>
                        </c:if>
                                            ...
                                            <c:if test="${counter.count %5 == 1}">
                                                <div class="row">
                                                    <div class="col-lg-2" style="border-style: solid;padding: 20px; margin: 20px;">
                                                        <div class="row">
                                                            <div class="col-lg-9">
                                                                <a class="folder" href="MainController?action=SharedWithMe&folderId=${folder.id}">
