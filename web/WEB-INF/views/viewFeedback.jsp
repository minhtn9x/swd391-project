 ...
 <c:set var="user" value="${sessionScope.LOGIN_USER}"/>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${F}" var="x">
                                        <tr>
                                            ...
                                            <td>${x.subject}</td>
                                            <td>
                                                <c:if test="${x.option==1}">
                                                    Feedback about our system
                                                </c:if>
                                                <c:if test="${x.option==2}">
                                                    Report users
                                                </c:if>
                                                <c:if test="${x.option==3}">
                                                    Others
                                                </c:if>
                                            </td>
                                            <td>
                                                <a href="MainController?action=feedbackDetail&fid=${x.feedbackID}">Detail</a>
                                                <a href="#" onclick="showMess(${x.feedbackID})">Delete</a>
                                            </td>
                                        </c:forEach>
    ...
    <script>
        function showMess(id){
            ...
            if(option===true){
                window.location.href='MainController?action=feedbackDelete&fid='+id;
            }
        }
...
<script src="https://unpkg.com//sweetalert/dist/sweetalert.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            if (status === "This feedback has been deleted") {
                swal("Success!", "This feedback has been deleted", "success");
