                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="${AccountsLink}">Accounts</a></li>
                            <li class="breadcrumb-item active">Add a new account</li>
                        </ol>
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                ...
                                <c:set var="input" value="${requestScope.USER_INFO}"/>
                                <div class="card-body">
                                    <form method="POST" action="MainController" class="register-form"
                                        ...
                                        <div class="form-group">
                                            <label for="userID"><i
                                                ...
                                                type="text" name="userID" id="userID" placeholder="User ID, e.g. John1234" required="required"
                                                <c:if test="${not empty input}">value="${input.userID}"</c:if>/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="fullName"><i class="zmdi zmdi-account"></i></label> <input
                                                type="text" name="fullName" id="fullName" placeholder="Full Name" required="required"
                                                <c:if test="${not empty input}">value="${input.fullName}"</c:if>/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="email"><i class="zmdi zmdi-email"></i></label> <input
                                                type="email" name="email" id="email" placeholder="Email, e.g. your.email@example.com" required="required"
                                                <c:if test="${not empty input}">value="${input.email}"</c:if>/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="password"><i class="zmdi zmdi-lock"></i></label> <input
                                                ...
                                                <c:if test="${not empty input}">value="${input.password}"</c:if>/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="birthday" id="birthday"
                                                   placeholder="Your Date of Birth" max="2008-01-01" required="required"
                                                   <c:if test="${not empty input}">value="${input.birthday}"</c:if>/>
                                        </div>
                                        <c:if test="${not empty error.birthday}">
                                            <div class="text-danger ml-1 text-center" style="color : red">
                                                ${error.birthday}
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phoneNumber" id="contact"
                                                   ...
                                                   <c:if test="${not empty input}">value="${input.phoneNumber}"</c:if>/>
                                        </div>
                                        <c:if test="${not empty error.phoneNumber}">
                                            <div class="text-danger ml-1 text-center" style="color : red">
                                                ${error.phoneNumber}
                                            </div>
                                        </c:if>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address" 
                                                   ...
                                                   <c:if test="${not empty input}">value="${input.address}"</c:if>/> 
                                        </div>
                                        <div class="form-group form-button">                                  
                                            <input type="submit" name="action" id="signup"
                                                   class="btn btn-primary px-4" style="width: 10em;" value="Add new" />
                                        </div>
                                    </form>
                                </div>
                            </div>
