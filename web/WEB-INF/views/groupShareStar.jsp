            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h2 class="h2 mb-4 text-gray-900">Starred</h2>
                                                ...
                                                <c:if test="${counter.count %5 == 1}">
                                                    <div class="row">
                                                        <div class="col-lg-2" style="border-style: solid;padding: 20px; margin: 20px;">
                                                            <div class="row">
                                                                <div class="col-lg-9">
                                                                    <a href="MainController?action=GroupShare&projectId=${param.projectId}&folderId=${folder.id}">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-content">
                                                                            <a href="MainController?action=RemoveStarFolder&projectId=${param.projectId}&folderId=${folder.id}">
                                                                                <i class="fas fa-regular fa-star"></i>&ensp;
                                                                                Remove from Starred
                                                                            </a>
                    ...
                    document.getElementById('renameId').value = '${folder.id}'" 
                                                                            ...
                                                                            <hr style="margin: 0">
                                                                            <a href="MainController?action=RemoveFolderInStarred&projectId=${param.projectId}&folderId=${folder.id}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown" style="float: right">
                                                            ...
                                                            <div class="dropdown-content">
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=RemoveStarFile&projectId=${param.projectId}&fileId=${file.id}">
                                                                    <i class="fas fa-regular fa-star"></i>&ensp;
                                                                    Remove from Starred
                                                                </a>
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=CopyFileInStarred&projectId=${param.projectId}&fileId=${file.id}&fileName=${file.name}">
                                                                ...
                                                                <hr style="margin: 0">
                                                                <a href="MainController?action=RemoveFileInStarred&projectId=${param.projectId}&fileId=${file.id}">
                                                                    <i class="fas fa-solid fa-trash"></i>&ensp;
                                                                    Remove
                                                                </a>
                                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="RenameFolderInStarred">OK</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="MainController">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-primary" name="action" value="RenameFileInStarred">OK</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="MainController" id="newFolderForm">
                                <div class="modal-body">
                                    <input id="renameInput" class="form-group" type="text" placeholder="Enter folder name" name="folderName" required />
                                    <input type="hidden" name="projectId" value="${param.projectId}" />
