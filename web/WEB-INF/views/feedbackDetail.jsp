...
<!--                                <div class="card shadow mb-4">
                         ...
                         <h1 class="h3 mb-4 text-gray-800"><a style="text-decoration: none" href="MainController?action=viewFeedback"><i class="fas fa-arrow-left"></i>&emsp;</a>Feedback Detail</h1>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <c:if test="${requestScope.F.option==1}">
                                                    Feedback about our system
                                                </c:if>
                                                <c:if test="${requestScope.F.option==2}">
                                                    Report users
                                                </c:if>
                                                <c:if test="${requestScope.F.option==3}">
                                                    Others
                                                </c:if>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <fmt:formatDate value="${requestScope.F.createdDate}" pattern="dd-MM-yyyy" />
                                            </div>
                                        </div>
                          ...
                          <a  href="MainController?aciton=reply&id=${requestScope.F.userID}"></a>
                            </div>
                                            </div>
                                    </div>
                                </div>
